			...
			<div class="nano">
				<div class="nano-content">
					...
					<div class="inner-menu-content">
						<a href="<?php echo base_url(); ?>index.php?student/message/message_new" class="btn btn-block btn-primary btn-md pt-sm pb-sm text-md">
						...
						<ul class="list-unstyled mt-xl pt-md">
							...
							foreach ($message_threads as $row):
								...
								?>
							<li>
								<a href="<?php echo base_url(); ?>index.php?student/message/message_read/<?php echo $row['message_thread_code']; ?>" class="menu-item <?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code']) echo 'active'; ?>">
									<?php echo $this->db->get_where($user_to_show_type, array($user_to_show_type . '_id' => $user_to_show_id))->row()->name; ?>
									<span class="label label-primary text-weight-normal pull-right">
										<?php echo $user_to_show_type; ?> </span>
