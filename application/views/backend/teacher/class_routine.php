			...
			<div class="col-md-12">
				<div class="panel panel-border panel-primary">
					<header class="panel-heading">
						<a href="<?php echo base_url();?>index.php?teacher/class_routine_print_view/<?php echo $class_id;?>/<?php echo $row['section_id'];?>" class="btn btn-default btn-xs pull-right" target="_blank">
						  <i class="glyphicon glyphicon-print"></i> <?php echo get_phrase('print');?>
						 </a>
						<h4 class="panel-title" style="font-size: 16px; text-align: center;">
...
<script type="text/javascript">
	function class_section( class_id ) {
		window.location.href = '<?php echo base_url(); ?>index.php?teacher/class_routine/' + class_id;
	}
</script>