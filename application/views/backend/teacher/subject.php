						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<!-- DELETION LINK -->
									<a href="#" class="btn btn-danger btn-xs" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo get_phrase('delete');?>" onclick="confirm_modal('<?php echo base_url();?>index.php?teacher/subject/delete/<?php echo $row['subject_id'];?>/<?php echo $class_id;?>');">
...
<script type="text/javascript">
    function class_section(class_id) {
      window.location.href = '<?php echo base_url(); ?>index.php?teacher/subject/' + class_id;
    }
</script>