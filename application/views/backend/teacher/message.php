				...
				<div class="nano">
					<div class="nano-content">
						...
						<div class="inner-menu-content">
							<a href="<?php echo base_url(); ?>index.php?teacher/message/message_new" class="btn btn-block btn-primary btn-md pt-sm pb-sm text-md">
							   ...
							   <?php
								...
								foreach ($message_threads as $row):
									...
									?>
										...
										<li>
											<a href="<?php echo base_url(); ?>index.php?teacher/message/message_read/<?php echo $row['message_thread_code']; ?>" class="menu-item <?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code']) echo 'active'; ?>">
